...
public:
	...
	virtual ConVar			*FindVar( const char *var_name ) = 0; //12
	virtual void			func15() = 0;
	virtual void			func16() = 0;
	virtual void			func17() = 0;
	virtual void			func18() = 0;
	virtual void			func19() = 0;
	virtual void			func20() = 0;//18
	...
	void ConsoleColorPrintf(const Color& MsgColor, const char* szMsgFormat, Values... Parameters)
	{
		...
		return U::GetVFunc<oConsoleColorPrintf>(this, 25)(this, MsgColor, szMsgFormat, Parameters...);
	}
};