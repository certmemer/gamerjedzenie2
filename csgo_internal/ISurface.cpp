...
bool	ISurface::IsTextureIDValid(int id)
{
	...
	return U::GetVFunc<OriginalFn>(this, 42)(this, id);
}

void	ISurface::DrawTexturedRect(int x0, int y0, int x1, int y1)
{
	typedef void(__thiscall* OriginalFn)(void*, int,int,int,int);
	return U::GetVFunc<OriginalFn>(this, 41)(this, x0,y0,x1,y1);
}
...
void ISurface::PlaySoundx(const char* fileName)
{
	typedef void(__thiscall* OriginalFn)(void*, const char*);
	return U::GetVFunc<OriginalFn>(this, 82)(this, fileName);
}

void ISurface::UnlockCursor()
{
	typedef void(__thiscall* OriginalFn)(void*);
	return U::GetVFunc<OriginalFn>(this, 66)(this);
}